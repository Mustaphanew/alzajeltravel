...
import 'package:alzajeltravel/services/notification_fcm/topic_service.dart';
...
Future<void> firebaseMessagingBackgroundHandler(RemoteMessage message) async {
  ...
  await NotificationFCMService.handleRemoteMessage(message);
}

class NotificationFCMService {
  static const String _defaultTopic = 'alzajeltravel';
  ...
  Future<void> initFCM() async {
    ...
    try {
      ...
      log('NotificationFCMService init error: $e', stackTrace: s);
    }
  }
  ...
  static Future<void> _handleOpen(Map<String, dynamic> data) async {
    ...
    log('FCM opened without route: ${jsonEncode(data)}');
  }
